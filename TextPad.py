...
import tkinter.filedialog #Same as the other thing above but for opening file
import tkinter.font #Changes the font for the text and the labels
...
#------------------------------------------------------
#Custom fonts
customFont = tkinter.font.Font(family="Helvetica", size=14)
#------------------------------------------------------
#Functions:
...
def help():
	...
	label_shortcuts = Label(help, text="keyboard shortcuts:").pack()
	label_quit = Label(help, text="Control-q quits the IDE").pack()
	label_save = Label(help, text="Control-s saves the current document").pack()
	label_open = Label(help, text="Control-o opens an existing text file").pack()
	help.mainloop()
...
TextArea.bind_all("<Control-s>", save_shortcut)
TextArea.bind_all("<Control-q>", quit)
TextArea.bind_all("<Control-o>", load_file_shortcut)
